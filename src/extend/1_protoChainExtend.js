 ...
 * 原型链继承
 * 
 * 重点：让子类的原型对象 指向 父类的实例（即子类实例的原型指向父类的实例）
 * 
 * 特点：
 * 子类实例可继承的属性有
 * 1. 父类构造函数属性
...
let instance1 = new Sub(20);
console.log(instance1.name); // 张三  子类实例可以访问父类实例的属性
...
// 缺点：改变子类的instance1实例原型上的共享属性，其他实例该属性也会改变
Object.getPrototypeOf(instance1).name = '李四';

let instance2 = new Sub(30);
